;(function ymapsInit(e) {
                        ...
                        var _ = {
                            ...
                            anyResolved: function (e) {
                                var n = new v(),
                                    t = e.length
                                return t
                                    ? (_._forEach(e, n.resolve, n.reject, n.notify, n), n.promise())
    ...
    r &&
        ...
        (t.supports.csp = {
            ...
            isNonceSupported:
                t.env.browser.name && t.env.browser.version
                    ? !(t.env.browser.name.search("Safari") != -1 && parseInt(t.env.browser.version) < 10)
                    : null,
        }),
        (function () {
            function e() {
        ...
        (function () {
            ...
            function o() {
                ...
                return (
                    o &&
                        ((e.vendor = r.getParameter(o.UNMASKED_VENDOR_WEBGL).replace(/\W/g, "_")),
                ...
                (t.prototype._loadBundle = function (e) {
                    return this._config
                        ...
                        ["catch"](function (n) {
                            throw (
                                (console.error(
                                    'ymaps: Failed to bundle "' + e + '".' + (n ? n.stack || n.message || "" : "")
                                ),
                                n)
                            )
                        })
    ...
    ;(t.modules = new o({
        ...
        (t.ns.load = function (e, n, r, o) {
            return "function" == typeof e
                ...
                : ("string" == typeof e && (e = [e]), t.ns.ready.apply(this, arguments))
        }),
        (function () {
            function e(e) {
                return function () {
                    ...
                    (1 != arguments.length || "object" != typeof arguments[0] || arguments[0].length
                        ? "function" != typeof arguments[0]
                            ? ((e.require = "string" == typeof arguments[0] ? [arguments[0]] : arguments[0]),
                              ...
                              (e.errorCallback =
                                  arguments[2] && "function" == typeof arguments[2] ? arguments[2] : null),
                              (e.context =
                                  arguments[2] && "object" == typeof arguments[2] ? arguments[2] : arguments[3]))
                            : ((e.successCallback = arguments[0]),
                              (e.errorCallback =
                                  arguments[1] && "function" == typeof arguments[1] ? arguments[1] : null),
                              (e.context =
                                  arguments[1] && "object" == typeof arguments[1] ? arguments[1] : arguments[2]))
                        : (e = arguments[0]))
                var n = e.require || [],
    ...
    server: {
        ...
        path: "build/release",
        params: { apikey: "2d296d07-bc2c-440f-ae05-2118d2c76a53", csp: null },
        version: "2.1",
    },
    preload: { load: "package.full", bundle: "full" },
    token: "e502fccf3d55ab1cb4c976eee2ad7ce8",
    taxiInceptionBboxes: [
        [
    ...
    vector: { version: "5.21.0", ts: 1676611844489 },
    hosts: {
        api: {
    ...
    layers: {
        map: {
            version: "23.02.15-0-b230203083000",
            scaled: true,
        ...
        sat: { version: "3.1052.0" },
        stv: { version: "2023.02.17.03.00-1_23.02.16-3-13712" },
        sta: { version: "2023.02.17.03.00-1_23.02.16-3-13712" },
        trf: { version: "1676611740", scaled: true },
    ...
    geolocation: {
        ...
        span: { longitude: 0.402401, latitude: 0.335823 },
    },
})
